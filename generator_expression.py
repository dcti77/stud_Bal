...
# gen_3st = (x**3 for x in gen_abs)
# print(next(gen_3st), next(gen_3st), next(gen_3st), next(gen_3st), sep=" ")
...
#
# from string import ascii_lowercase
# mix_gen = (x + y for x in ascii_lowercase for y in ascii_lowercase)
# for i in range(50):
#     print(next(mix_gen), end=' ')
...
# cities = ["Москва", "Ульяновск", "Самара", "Уфа", "Омск", "Тула"]
# gen = (x for y in range(180000) for x in cities)
